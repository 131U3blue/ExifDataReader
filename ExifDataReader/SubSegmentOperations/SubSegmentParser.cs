...
namespace ExifDataReader.Markers.IFDMarkers {
    abstract class SubSegmentParser : ISubSegmentParser {
        ...
        public virtual bool MatchesMarker(IByteReader byteReader, Span<byte> potentialMarker) => byteReader.MatchesBigEndianByteString(ExpectedMarkerBigEndian, potentialMarker);
